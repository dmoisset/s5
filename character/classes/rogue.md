...
You’re a shadow. You move swiftly, strike suddenly, and always have an escape plan. You’re a consummate professional, and 
you always get the job done, whether it’s scouting enemy lines, hunting down criminals, stealing and smuggling items, or 
assassinating key figures. As an operative, you’re skilled in a wide variety of disciplines and specialties, and use speed, 
mobility, and your quick wits rather than relying on heavy weapons. You excel at the art of surprise, whether it’s sniping 
targets from cover or striking while their backs are turned. Your cause may be righteous, but you have no problem fighting 
dirty—achieving your objective is all that matters.
...
* **Field treatment:** You can spend a Resolve Point and a minute to gain 3 × your level hit points.
* **Holographic Clone:** As a standard action you can get effects equivalent to a *Mirror Image* spell. Once you use this 
  ability, you can’t use it again until your next long rest.
* **Innoculation:** You are considered proficient in Constitution saves vs disease and poison.
* **Jack of all trades:** You add half your proficiency to skills you’re not proficient with. This works like the Bard
  ability of the same name.
* **Nightvision:** You get Darkvision up to 60 feet
* **Quick Movement:** Your speed increases by 10 feet.
* **Uncanny Pilot:** :warning: vehicle rules
* **Bleeding Shot** (requires level 9): When you score a Sneak Attack, you can inflict a Bleed effect equal to your level. 
  You can only add a single extra effect to your sneak attack.
* **Certainty** (requires level 9): After rolling your specialization skill or one of your expertise skills, as a reaction 
  you can spend a Resolve Point to reroll the skill check and choose which roll to keep.
* **Cloaking Field** (requires level 9): As a bonus action you can activate a cloaking field that makes you lightly obscured 
  (and the effect applies to sound too). This allows you to hide even if you’re being observed and without cover. If you 
  don’t move nor take actions in a round while hidden, you gain a +10 bonus to your previous stealth roll. This field has 10 
  charges and one is spent when activating, or starting your turn with the field active. The charges are restored when you 
  take a long or short rest.
* **Deactivating Shot** (requires level 9): When you score a Sneak Attack, you can suppress a magical or technological item, 
  weapon or armor upgrade worn by the target. Roll 1d20+your proficiency vs 10+the item min proficiency. If you succeed the 
  item loses its magical/technological functions until the beginning of your next turn. The target can spend a bonus action 
  and attempt an Int(Engineering) or Int(Mysticism) check against your operative exploit DC to reactivate the device.
...
* **Ever Vigilant** (requires level 9): You still have your passive perception while sleeping, as long as what you’re 
  sensing is not purely visual
* **Glimpse the truth** (requires level 9): As an action you can spend 1 Resolve point to gain truesight until the end of 
  your next turn
* **Hampering Shot** (requires level 9): When you score a Sneak Attack, you can reduce your target speed to half its normal 
  until the beginning of your next turn. You can only add a single extra effect to your sneak attack.
* **Holographic Distraction** (requires level 9): As an action, you create a holographic duplicate of you that moves away
  from you for a minute. It moves as if you were dashing and its movement can include climbing, jumping and avoiding any 
  obstacles. Any creature interacting with the duplicate gets an Intelligence saving throw to recognize it’s not real.
* **Interfering Shot** (requires level 9): When you score a Sneak Attack, you can stop your target from taking reactions 
...
* **Speed Hacker** (requires level 9): You can disarm/disable mechanical and electronic devices using Engineering/computers 
  at half the usual time.
* **Staggering Shot** (requires level 9): When you score a Sneak Attack, you can stop your target from taking both an 
  action and a bonus action until the beginning of your next turn. The target chooses which (action or bonus) it can take on 
  its turn. You can only add a single extra effect to your sneak attack.
* **Stunning Shot**  (requires level 9): When you score a Sneak Attack, you can stun your target if it fails a Constitution 
  saving throw. After the attempt, the target is immune to this ability until it takes a long rest. You can only add a
  single extra effect to your sneak attack.
* **Uncanny Mobility** (requires level 9): When you use an action to Dash you don’t provoke attacks of opportunity.
* **Uncanny Shooter** (requires level 9): You don’t shoot at disadvantage when firing a small arm within 5 feet of a hostile 
  creature.
* **Versatile Movement** (requires level 9): Climbing or swimming no longer costs you extra movement.
* **Efficient Cloaking Field** (requires level 13 and the Cloaking Field exploit): Your cloaking field has 100 charges (10 
  minutes). As a bonus action, you can spend a Resolve Point to recover 20 used charges even if the field is active.
* **Knockout Shot** (requires level 13 and both the Staggering Shot and Stunning Shot exploits): When you score a Sneak 
  Attack, you can knock your target unconscious if it fails a Constitution saving throw. After the attempt, the target is 
  immune to this ability until it takes a long rest. You can only add a single extra effect to your sneak attack.
* **Multiattack Mastery** (requires level 13): If when using the Extra Attack you land at least 2 hits on your target 
  without using Sneak Attack, you can apply one of the exploit effects that are allowed in a Sneak Attack to the last hit.
...
additional operative exploit, even if you don’t meet the prerequisites for it.

* **Daredevil:** Acrobatics (you move quickly to land a sneak attack); Versatile movement exploit
...
At 9th Level you can attack twice instead of once, when you take the attack action in your turn.
